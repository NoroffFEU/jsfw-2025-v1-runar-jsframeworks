  ...
  if (state.items.length === 0) {
    return (
      <div className="py-16 text-center">
        ...
        <Link
          className="inline-flex mt-4 rounded px-4 py-2 bg-white text-black"
          href="/"
        >
          Back to shop
        </Link>
    ...
    <section className="space-y-6">
      ...
      <div className="space-y-3">
        {state.items.map((i) => (
          <div
            key={i.id}
            className="rounded bg-white/5 p-4 flex items-center justify-between gap-4"
          >
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <button
                className="rounded px-3 py-1 bg-white/10 cursor-pointer"
                onClick={() => remove(i.id)}
              >
                Remove
              </button>
